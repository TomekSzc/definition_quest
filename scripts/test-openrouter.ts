...
async function testOpenRouterConnection() {
  ...
  try {
    ...
    console.log(
      `   Tokens: ${completion.usage.totalTokens} (prompt: ${completion.usage.promptTokens}, completion: ${completion.usage.completionTokens})`
    );
    ...
    const result = jsonCompletion.json as { concepts: { term: string; definition: string }[] };

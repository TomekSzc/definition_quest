...
| Błąd 401/403/500 | Toast typu *error* z opisem |
...
- Po pomyślnym logowaniu komponent sprawdza, czy odpowiedź zawiera `user` i `session`, w przeciwnym razie zwróci toast *error*.

...
describe("PairFormRow", () => {
  ...
  it("renders both term and definition inputs with correct placeholders", () => {
    render(<PairFormRow index={0} register={mockRegister} onRemove={mockOnRemove} />);
  ...
  it("renders with correct testid for the row container", () => {
    render(<PairFormRow index={3} register={mockRegister} onRemove={mockOnRemove} />);
  ...
  it("renders term and definition inputs with correct testids based on index", () => {
    render(<PairFormRow index={2} register={mockRegister} onRemove={mockOnRemove} />);
  ...
  it("renders remove button with correct testid", () => {
    render(<PairFormRow index={1} register={mockRegister} onRemove={mockOnRemove} />);
  ...
  it("calls register with correct field names for term and definition", () => {
    render(<PairFormRow index={4} register={mockRegister} onRemove={mockOnRemove} />);
  ...
  it("displays error message for term when term error is provided", () => {
    ...
    render(<PairFormRow index={0} register={mockRegister} errors={{ term: termError }} onRemove={mockOnRemove} />);
  ...
  it("displays error message for definition when definition error is provided", () => {
    ...
    render(
      <PairFormRow index={0} register={mockRegister} errors={{ definition: definitionError }} onRemove={mockOnRemove} />
    );
